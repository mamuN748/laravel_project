...
@section('content')
  <div class="row">
      <div class="col-md-12 ">
          <form method="post" action="{{url('dashboard/Income/cetegory/submit')}}">
              @csrf
              <div class="card mb-3">
                <div class="card-header">
                  <div class="row">
                      ...
                      <div class="col-md-4 card_button_part">
                          <a href="{{url('dashboard/Income/cetegory')}}" class="btn btn-sm btn-dark"><i class="fas fa-th"></i>All Category</a>
                      </div>
                  </div>
                </div>
                <div class="card-body">
