                ...
                <div class="col-md-2 sidebar_part">
                    ...
                    <div class="menu">
                        <ul>
                            ...
                            <li><a href="{{url('dashboard/income')}}"><i class="fa solid fa-wallet"></i> Income</a></li>
                            <li><a href="{{url('dashboard/expense')}}"><i class="fa solid fa-coins"></i> Expense</a></li>
                            <li><a href="#"><i class="fa solid fa-fill"></i> Reports</a></li>
